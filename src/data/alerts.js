...
export const alerts = [
  {
    ...
    body: '10,900 fans now engage primarily on social without attending. This is your fastest-growing and most under-monetised audience — a prime target for streaming and merch conversion.',
    source: 'Social · Web',
  ...
  },
  {
    ...
    level: 'warn',
    icon: 'UserMinus',
    title: '180 committed regulars trending toward lapsed',
    body: 'These 180 fans attended 4+ games last season but have no ticket, email open, or app activity in 90 days. Historically, win-back within 30 days is 3× more effective than after they fully lapse.',
    source: 'Ticketmaster · Mailchimp · Matchday+ App',
  ...
  },
  {
    ...
    body: 'Average concourse spend per attendee rose to £8.40 (+£0.90) since the in-app cashless campaign. Family & junior segment drove most of the F&B uplift.',
    source: 'Matchday+ App',
  ...
  },
  {
    ...
    level: 'crit',
    icon: 'AlertTriangle',
    title: '4,100 profiles missing marketing consent',
    body: '19% of unified profiles cannot be contacted for marketing. A preference-centre re-permission prompt at next ticket purchase could recover an estimated 900 addressable fans.',
    source: 'App & Fan Accounts · Mailchimp',
  ...
  },
  {
    ...
    body: 'Renewal campaign closed at 520 renewals — up 9pts year on year. Superfans renewed at 96%. Personalised, segment-timed reminders drove the uplift.',
